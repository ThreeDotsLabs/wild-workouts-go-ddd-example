...
type ClientInterface interface {
	...
	// GetCurrentUser performs a GET /users/current (the `GetCurrentUser` operationId) request.
...
type ClientWithResponsesInterface interface {
	...
	// GetCurrentUserWithResponse performs a GET /users/current (the `GetCurrentUser` operationId) request.
	//
