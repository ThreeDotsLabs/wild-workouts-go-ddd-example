...
type ClientInterface interface {
	...
	// GetTrainings performs a GET /trainings (the `GetTrainings` operationId) request.
	GetTrainings(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CreateTrainingWithBody performs a POST /trainings (the `CreateTraining` operationId) request,
	...
	// CreateTraining performs a POST /trainings (the `CreateTraining` operationId) request.
	...
	// CancelTraining performs a DELETE /trainings/{trainingUUID} (the `CancelTraining` operationId) request.
	CancelTraining(ctx context.Context, trainingUUID openapi_types.UUID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ApproveRescheduleTraining performs a PUT /trainings/{trainingUUID}/approve-reschedule (the `ApproveRescheduleTraining` operationId) request.
	...
	// RejectRescheduleTraining performs a PUT /trainings/{trainingUUID}/reject-reschedule (the `RejectRescheduleTraining` operationId) request.
	...
	// RequestRescheduleTrainingWithBody performs a PUT /trainings/{trainingUUID}/request-reschedule (the `RequestRescheduleTraining` operationId) request,
	// with any type of body and a specified content type.
	...
	// RequestRescheduleTraining performs a PUT /trainings/{trainingUUID}/request-reschedule (the `RequestRescheduleTraining` operationId) request.
	// Takes a body of the `application/json` content type.
	...
	// RescheduleTrainingWithBody performs a PUT /trainings/{trainingUUID}/reschedule (the `RescheduleTraining` operationId) request,
	// with any type of body and a specified content type.
	...
	// RescheduleTraining performs a PUT /trainings/{trainingUUID}/reschedule (the `RescheduleTraining` operationId) request.
	// Takes a body of the `application/json` content type.
...
// NewGetTrainingsRequest constructs an http.Request for the GetTrainings method
...
// NewCreateTrainingRequestWithBody constructs an http.Request for the CreateTraining method, with any body, and a specified content type
...
// NewApproveRescheduleTrainingRequest constructs an http.Request for the ApproveRescheduleTraining method
...
// NewRejectRescheduleTrainingRequest constructs an http.Request for the RejectRescheduleTraining method
...
// NewRequestRescheduleTrainingRequestWithBody constructs an http.Request for the RequestRescheduleTraining method, with any body, and a specified content type
...
// NewRescheduleTrainingRequestWithBody constructs an http.Request for the RescheduleTraining method, with any body, and a specified content type
...
type ClientWithResponsesInterface interface {
	...
	// GetTrainingsWithResponse performs a GET /trainings (the `GetTrainings` operationId) request.
	//
	// Returns a wrapper object for the known response body format(s).
	GetTrainingsWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetTrainingsResponse, error)

	// CreateTrainingWithBodyWithResponse performs a POST /trainings (the `CreateTraining` operationId) request,
	// with any type of body and a specified content type.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// CreateTrainingWithResponse performs a POST /trainings (the `CreateTraining` operationId) request.
	...
	// CancelTrainingWithResponse performs a DELETE /trainings/{trainingUUID} (the `CancelTraining` operationId) request.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// ApproveRescheduleTrainingWithResponse performs a PUT /trainings/{trainingUUID}/approve-reschedule (the `ApproveRescheduleTraining` operationId) request.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// RejectRescheduleTrainingWithResponse performs a PUT /trainings/{trainingUUID}/reject-reschedule (the `RejectRescheduleTraining` operationId) request.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// RequestRescheduleTrainingWithBodyWithResponse performs a PUT /trainings/{trainingUUID}/request-reschedule (the `RequestRescheduleTraining` operationId) request,
	// with any type of body and a specified content type.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// RequestRescheduleTrainingWithResponse performs a PUT /trainings/{trainingUUID}/request-reschedule (the `RequestRescheduleTraining` operationId) request.
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	...
	// RescheduleTrainingWithBodyWithResponse performs a PUT /trainings/{trainingUUID}/reschedule (the `RescheduleTraining` operationId) request,
	// with any type of body and a specified content type.
	//
	// Returns a wrapper object for the known response body format(s).
	...
	// RescheduleTrainingWithResponse performs a PUT /trainings/{trainingUUID}/reschedule (the `RescheduleTraining` operationId) request.
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
...
func (r GetTrainingsResponse) GetJSON200() *Trainings {
	return r.JSON200
}

// GetJSONDefault returns the response for an HTTP default `application/json` response
func (r GetTrainingsResponse) GetJSONDefault() *Error {
	return r.JSONDefault
}

// GetBody returns the raw response body bytes
func (r GetTrainingsResponse) GetBody() []byte {
	return r.Body
}
...
func (r GetTrainingsResponse) ContentType() string {
	if r.HTTPResponse != nil {
...
// GetJSONDefault returns the response for an HTTP default `application/json` response
func (r CreateTrainingResponse) GetJSONDefault() *Error {
	return r.JSONDefault
}

// GetBody returns the raw response body bytes
func (r CreateTrainingResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r CreateTrainingResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSONDefault returns the response for an HTTP default `application/json` response
func (r CancelTrainingResponse) GetJSONDefault() *Error {
	return r.JSONDefault
}

// GetBody returns the raw response body bytes
func (r CancelTrainingResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r CancelTrainingResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSONDefault returns the response for an HTTP default `application/json` response
func (r ApproveRescheduleTrainingResponse) GetJSONDefault() *Error {
	return r.JSONDefault
}

// GetBody returns the raw response body bytes
func (r ApproveRescheduleTrainingResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r ApproveRescheduleTrainingResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSONDefault returns the response for an HTTP default `application/json` response
func (r RejectRescheduleTrainingResponse) GetJSONDefault() *Error {
	return r.JSONDefault
}

// GetBody returns the raw response body bytes
func (r RejectRescheduleTrainingResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r RejectRescheduleTrainingResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSONDefault returns the response for an HTTP default `application/json` response
func (r RequestRescheduleTrainingResponse) GetJSONDefault() *Error {
	return r.JSONDefault
}

// GetBody returns the raw response body bytes
func (r RequestRescheduleTrainingResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r RequestRescheduleTrainingResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSONDefault returns the response for an HTTP default `application/json` response
func (r RescheduleTrainingResponse) GetJSONDefault() *Error {
	return r.JSONDefault
}

// GetBody returns the raw response body bytes
func (r RescheduleTrainingResponse) GetBody() []byte {
	return r.Body
}
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r RescheduleTrainingResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
